...
// @include /^(https?:\/\/)(.+)?((inshort|youlinks|adrinolinks).in|(linkcents|nitro-link).com|clk.sh|shorthop.fun)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?((devnote|formshelp|rcccn).in|djbassking.live|carbikenation.com)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?(financedoze.com|techhype.in|getpdf.net)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?((admediaflex|cdrab|financekita|jobydt|foodxor|mealcold|newsobjective|gkvstudy|mukhyamantriyojanadoot|thepragatishilclasses).com|(ecq|cooklike).info|(wpcheap|bitwidgets|newsamp).net|atomicatlas.xyz|gadifeed.in|thecryptoworld.site|skyfreecoins.top|petly.lat|techreviewhub.store|mbantul.my.id)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?(dutchycorp.ovh|(encurt4|10short).com|seulink.digital|oii.io|hamody.pro|metasafelink.site|wordcounter.icu|pwrpa.cc|flyad.vip|seulink.online|pahe.plus)(\/.*)/
